...
class GUI:
    ...
    def show_user_page(self):
        ...
        ttk.Button(self.main_frame, text="Train model with new parameters", width=40, command=self.train_model).pack(pady=10)
        ttk.Button(self.main_frame, text="Exit", style="Exit.TButton", command=self.confirm_exit).pack(pady=30)
    ...
    def insert_values(self):
        print("Insert values for estimation - placeholder")

    def search_results(self):
        print("Search previous results - placeholder")

    def train_model(self):
        print("Train model with new parameters - placeholder")
